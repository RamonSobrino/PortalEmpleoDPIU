module.exports = function(app, swig, gestorBD) {
	...
	app.get('/cancion/comprar/:id', function (req, res) {
		...
		gestorBD.usuarioComprarCancion(criterioUsuario, cancionId ,function(canciones){
			if ( canciones == null ){
				res.send(respuesta);
			} else {
	...
	app.get('/compras', function (req, res) {
		...
		gestorBD.usuarioCancionesCompradas(criterioUsuario ,function(canciones){
			if (canciones == null) {
				res.send("Error al listar ");
			} else {
    ...
    app.get("/tabla", function(req, res) {
        ...
        gestorBD.obtenerCanciones(criterio, function(canciones) {
            if (canciones == null) {
                ...
                var respuesta = swig.renderFile('views/btabla.html',
                    {
                        canciones : canciones,
                    });
                res.send(respuesta);
